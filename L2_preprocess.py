...
class L2DataPreprocessor:
    ...
    def print_missing_data(self):
        print(
            ...
            f" missing in age_gender vs demo   :  {self.age_gender_lang_subject_id.difference(self.demo_lang_subject_id)} \n",
            f"missing in age_gender vs fixation:  {self.age_gender_lang_subject_id.difference(self.lang_data_subject_id)} \n\n",

            f" missing in fixation vs demo   :  {self.lang_data_subject_id.difference(self.demo_lang_subject_id)} \n",
            f"missing in demo vs fixation   :  {self.demo_lang_subject_id.difference(self.lang_data_subject_id)} \n\n",
        )
